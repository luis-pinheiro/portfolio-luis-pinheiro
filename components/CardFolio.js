...
const CardFolio = ({ children, classes, vh }) => {
  return (
    <main
      id="card-folio"
      className="container relative flex w-full pt-16 m-auto mb-5 overflow-hidden align-middle bg-white rounded sm:px-14 pb-14 dark:bg-nord0 elevation-5 bg-clip-padding"
    >
