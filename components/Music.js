...
const Music = () => {
  ...
  return (
    <div id="music" className="fixed flex rounded-full z-70 w-11 h-7 bottom-40 right-4">
      <label htmlFor="toggleMusic" className="flex items-center justify-center rounded-full cursor-pointer">
        <div className="relative rounded-full ">
          ...
          <div className="flex items-center justify-center w-8 h-8 text-base border-2 rounded-full bg-nord3 border-nord6 dark:bg-nord6 dark:text-nord3 dark:border-nord3 elevation-5 z-70 text-nord4">
